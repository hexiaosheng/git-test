...
Ext.define('app.view.Guide', {
    ...
    config: {
        ...
        html: '<div class="bgImg bv"><div class="text bone">点击按钮,向后翻页,或者等待三秒,都将进入首页</div><div class="bthree"><div class="guideBtn" fire="guideBtn"><div class="guideIco" ></div></div></div></div>'
    },
    initialize: function () {
        var me = this;
        //监听当前项激活与取消激活事件
